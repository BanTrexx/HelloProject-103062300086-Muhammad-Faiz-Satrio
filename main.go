...
const accountsFilePath = "account.json"
...
func registerAccount(scanner *bufio.Scanner) {
	...
	if _, exists := registrations[id]; exists {
		fmt.Println("Registration already submitted.")
		return
	}
...
func handleRegistrations(scanner *bufio.Scanner) {
	...
	saveAccounts() // Panggil saveAccounts setelah membuka kunci
}
...
func loadAccounts() {
	...
	log.Println("Accounts loaded successfully.")
}
